...
class Model(nn.Module):
    ...
    def __init__(self, hyperparams):
        ...
        self.encoder_layer_0 = EncoderLayer()
        self.encoder_layer_1 = EncoderLayer()

        self.decoder_layer_0 = DecoderLayer()
        self.decoder_layer_1 = DecoderLayer()
    ...
    def forward(self, z_input, t):
        ...
        z1_decode, x_decode_layer_1 = decoder_layer_1(z2_decode)
        z0_decode, x_decode_layer_0 = decoder_layer_0(z1_decode)
